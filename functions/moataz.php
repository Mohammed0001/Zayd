...
if ($_GET["type"] == "sellproduct") {
    ...
    //".$_COOKIE["SSN"]."
    $sql = "INSERT INTO  `product`(`id`, `name`, `bidExpiry`, `minBid`,`currentBid` , `description`, `status`, `categoryName`, `userID`) VALUES ('".$_POST['id']."' ,'".$_POST['name']."' ,'".$_POST['bidExpiry']."','".$_POST['minBid']."' ,'".$_POST['currentBid']."','Location : " . $_POST["location"].$_POST['description']."','".$_POST['status']."','".$_POST['categoryName']."','1234567')";
    if ($conn->query($sql)) {
        echo "DONE";
